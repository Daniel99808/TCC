                ...
                <form onSubmit={editingId ? handleSaveEdit : handleSubmit} className="space-y-3">
                  ...
                  <div className="flex gap-2 pt-2">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2.5 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg transition-all duration-300 group relative overflow-hidden text-xs sm:text-sm text-orange-500 hover:text-orange-400 bg-gradient-to-r from-orange-900/30 to-orange-800/20 hover:from-orange-900/50 hover:to-orange-800/40 border border-orange-700/40 hover:border-orange-600/60 shadow-lg hover:shadow-xl hover:shadow-orange-500/20 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-lg disabled:hover:shadow-orange-500/0"
                    >
