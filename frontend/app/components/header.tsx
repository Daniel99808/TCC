        ...
        <nav className="p-3 sm:p-4">
          ...
          <li>
            ...
            >
              ...
              <span className="font-semibold text-base sm:text-lg transition-transform duration-300 group-hover:translate-x-1">Início</span>
            </a>
          </li>            <li>
              <a 
              href="/mural" 
              ...
              >
                ...
                <span className="font-semibold text-base sm:text-lg transition-transform duration-300 group-hover:translate-x-1">Mural</span>
              </a>
            </li>
