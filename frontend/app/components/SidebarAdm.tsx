  ...
  return (
    <>
      ...
      <aside className={`fixed left-0 top-0 h-screen w-full sm:w-[280px] md:w-[320px] lg:w-[360px] shadow-2xl transition-all duration-300 z-40 bg-gradient-to-br from-gray-900/95 via-gray-900/90 to-gray-800/95 backdrop-blur-2xl border-r border-white/10 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'} shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] flex flex-col`}>
        ...
        {/* Linha de brilho no topo - dourada para admin */}
          ...
          <div className="relative p-3 sm:p-4 md:p-5 lg:p-6 border-b border-white/5 transition-colors duration-300 shrink-0">
            ...
            >
              ...
              <div className="relative w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0">
                {/* Anel decorativo com gradiente dourado */}
                <div className="absolute inset-0 rounded-full transition-all duration-300 group-hover:scale-110 bg-gradient-to-br from-amber-500 via-amber-600 to-amber-700 p-[2px]">
        ...
        <nav className="p-2.5 sm:p-3 md:p-4 flex-1 overflow-y-auto scrollbar-hide">
          <ul className="space-y-1.5 sm:space-y-2">
            <li>
              ...
              >
                <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-0 group-hover:h-3/5 bg-gradient-to-b from-amber-500 to-amber-600 rounded-r-full transition-all duration-300" />
        ...
        <div className="p-2.5 sm:p-3 md:p-4 border-t border-white/10 bg-gradient-to-t from-gray-900/95 via-gray-900/80 to-transparent backdrop-blur-xl shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2.5 sm:gap-3 md:gap-4 px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 md:py-3 rounded-lg transition-all duration-300 w-full group relative overflow-hidden text-sm sm:text-base text-amber-500 hover:text-amber-400 bg-gradient-to-r from-amber-900/30 to-amber-800/20 hover:from-amber-900/50 hover:to-amber-800/40 border border-amber-700/40 hover:border-amber-600/60 shadow-lg hover:shadow-xl hover:shadow-amber-500/20"
          >
