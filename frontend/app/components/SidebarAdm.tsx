  ...
  return (
    <>
      ...
      {isMobileMenuOpen && (
        ...
        <div className="h-px bg-gradient-to-r from-transparent via-orange-500/50 to-transparent" />        {/* Perfil do Usuário com Glassmorphism Premium */}
        {usuarioLogado && (
          <div className="relative p-3 sm:p-4 md:p-5 lg:p-6 border-b border-white/5 transition-colors duration-300 shrink-0">
            ...
            >
              ...
              <div className="relative w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0">
                {/* Anel decorativo com gradiente laranja */}
                <div className="absolute inset-0 rounded-full transition-all duration-300 group-hover:scale-110 bg-gradient-to-br from-orange-600 via-orange-700 to-orange-800 p-[2px]">
          ...
          <ul className="space-y-1.5 sm:space-y-2">
            ...
            <li>
              ...
              >
                ...
                <div className="relative flex items-center">
                  ...
                  <span className="absolute -top-1 -right-1 text-lg font-bold text-orange-500">+</span>
                </div>
                <span className="font-medium text-base sm:text-lg transition-transform duration-300 group-hover:translate-x-1">Cadastro de Usuários</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="font-medium text-base sm:text-lg transition-transform duration-300 group-hover:translate-x-1">Gerenciar Mural</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="font-medium text-base sm:text-lg transition-transform duration-300 group-hover:translate-x-1">Gerenciar Calendário</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="font-medium text-base sm:text-lg transition-transform duration-300 group-hover:translate-x-1">Relatórios (AAPM)</span>
              </a>
            </li>
        ...
        </nav>        {/* Rodapé - Botão Sair com Glassmorphism Premium */}
        <div className="p-2.5 sm:p-3 md:p-4 border-t border-white/10 bg-gradient-to-t from-gray-900/95 via-gray-900/80 to-transparent backdrop-blur-xl shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2.5 sm:gap-3 md:gap-4 px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 md:py-3 rounded-lg transition-all duration-300 w-full group relative overflow-hidden text-sm sm:text-base text-orange-500 hover:text-orange-400 bg-gradient-to-r from-orange-900/30 to-orange-800/20 hover:from-orange-900/50 hover:to-orange-800/40 border border-orange-700/40 hover:border-orange-600/60 shadow-lg hover:shadow-xl hover:shadow-orange-500/20"
          >
            {/* Efeito de brilho ao hover */}
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-orange-500/10 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />
            </div>
