  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-3 left-3 z-50 lg:hidden p-2.5 rounded-lg bg-gray-800 text-white shadow-lg"
        aria-label="Menu"
      >
      ...
      <aside className={`fixed left-0 top-0 h-screen w-[300px] sm:w-[320px] md:w-[350px] lg:w-[360px] transition-all duration-500 ease-in-out z-40 bg-gradient-to-br from-gray-900/95 via-gray-900/90 to-gray-800/95 backdrop-blur-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] border-r border-white/10 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'} flex flex-col`}>
        ...
        <nav className="p-2.5 sm:p-3 md:p-4 flex-1 overflow-y-auto scrollbar-hide">
          <ul className="space-y-2 sm:space-y-2.5">
            ...
            <a 
              ...
              onClick={() => setIsMobileMenuOpen(false)}
              className="flex items-center gap-4 sm:gap-5 px-4 sm:px-5 py-3.5 sm:py-4 rounded-xl transition-all duration-300 group relative overflow-hidden text-gray-300 hover:text-white hover:bg-white/10 border border-transparent hover:border-white/20 hover:shadow-lg"
              >
                <div className="absolute left-0 top-0 bottom-0 w-1 rounded-r-full transition-all duration-300 opacity-0 group-hover:opacity-100 bg-gradient-to-b from-red-600 to-red-700 shadow-lg shadow-red-600/50" />
            ...
            <a 
              ...
              >
                ...
                <span className="font-semibold text-base sm:text-lg transition-transform duration-300 group-hover:translate-x-1">Conversas</span>
              </a>
            </li>
        ...
        <div className="p-3 sm:p-4 border-t border-white/10 bg-gradient-to-t from-gray-900/95 via-gray-900/80 to-transparent backdrop-blur-xl shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-4 sm:gap-5 px-4 sm:px-5 py-3.5 sm:py-4 rounded-xl transition-all duration-300 w-full group relative overflow-hidden text-red-500 hover:text-red-400 bg-gradient-to-r from-red-900/30 to-red-800/20 hover:from-red-900/50 hover:to-red-800/40 border border-red-700/40 hover:border-red-600/60 shadow-lg hover:shadow-xl hover:shadow-red-500/20"
          >
