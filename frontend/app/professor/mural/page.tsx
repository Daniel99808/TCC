      ...
      <main className={`transition-all duration-300 flex-1 p-3 sm:p-4 md:p-6 lg:p-8 flex flex-col items-center overflow-auto animate-fade-in ${
        ...
        <div className="w-full max-w-3xl mb-6">
          <button
            ...
            className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white py-3 sm:py-4 px-6 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 text-base sm:text-lg"
          >
